...
public final class TypedRecordProcessors {
  ...
  private TypedRecordProcessors(final KeyGenerator keyGenerator, final StateWriter stateWriter) {
  ...
  public static TypedRecordProcessors processors(
    ...
    return new TypedRecordProcessors(keyGenerator, stateWriter);
  }
  ...
  public <T extends UnifiedRecordValue> TypedRecordProcessors onCommand(
    ...
    return onCommand(
        valueType, intent, new CommandProcessorImpl<>(keyGenerator, stateWriter, commandProcessor));
  }
